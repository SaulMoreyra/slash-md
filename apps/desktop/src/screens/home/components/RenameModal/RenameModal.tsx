...
export function RenameModal({ target, busy = false, onClose, onSave }: Props) {
  ...
  const heading = isFolder ? t("home.modals.rename.titleFolder") : t("home.modals.rename.titleFile");
  const lede = isFolder ? t("home.modals.rename.hintFolder") : t("home.modals.rename.hintFile");
