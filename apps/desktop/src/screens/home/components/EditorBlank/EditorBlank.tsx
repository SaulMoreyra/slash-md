...
export function EditorBlank({ section, createIntent = CreateIntent.Page, busy, onCreate }: Props) {
  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col justify-center overflow-auto px-8 py-12">
      ...
      <p className="mx-auto mb-6 w-full max-w-lg text-sm text-muted">{hint}</p>
