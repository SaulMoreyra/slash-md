...
export type EditorChromeHandles = {
  ...
  frontmatter: { apply(fields: import("../../../src/domain/protocol").FrontmatterFields): void };
  icon: { apply(fields: import("../../../src/domain/protocol").FrontmatterFields): void };
  cover: {
    apply(fields: import("../../../src/domain/protocol").FrontmatterFields): void;
    onHostMessage(msg: HostToWebview): void;
  };
  edited: {
    apply(payload: import("../../../src/domain/protocol").FileEditorsPayload): void;
    onHostMessage(msg: HostToWebview): void;
  };
};
