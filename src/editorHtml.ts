import { FrontmatterFields, HostToWebview, WebviewBoot } from "./protocol";
...
<body class="workflow-${init.workflow}${init.workflow === "workspace" && init.repoMode === "personal" ? " repo-personal" : init.workflow === "workspace" ? " repo-workspace" : ""}">
  <header class="bar">
