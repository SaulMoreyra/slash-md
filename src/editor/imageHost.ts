...
import { defaultDocPath, referencedImages, sanitizeImageName, uniqueImageRepoPath } from "../domain/images";
import { imageRepoPath, posixBasename, posixDirname, posixJoin, posixNormalize, relativeHref } from "../domain/paths";
